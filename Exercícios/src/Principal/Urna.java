...
public class Urna {
  ...
  /*omicron é uma letra grega*/
    Scanner omicron = new Scanner(System.in);
    ...
    while (true) {
        ...
        int resposta = omicron.nextInt();
            if (resposta == 13){
                System.out.println("Confirmar voto para 'Thomas Turbando?' [S/N]");
                String confirmar = omicron.next().toUpperCase();
                confirmar.charAt(0);
